...
```{r}
dadosPNADc2023_1SR <- dadosPNADC_2023 %>% 
  dplyr::filter(Trimestre == 1)  
dadosPNADc2023_1SR <- srvyr::as_survey(dadosPNADc2023_1SR)
```
...
dadosPNADc2023_1SR %>% 
  ...
  dplyr::summarise(freq = srvyr::survey_count())
```
...
```{r}
dadosPNADc2023_2SR <- dadosPNADC_2023 %>% 
  dplyr::filter(Trimestre == 2)  
dadosPNADc2023_2SR <- srvyr::as_survey(dadosPNADc2023_2SR)
```
...
dadosPNADc2023_2SR %>% 
  dplyr::group_by(cod_SCN) %>% 
  srvyr::survey_count(vartype = c("se", "ci", "var", "cv"))
```
...
```{r}
dadosPNADc2023_3SR <- dadosPNADC_2023 %>% 
  dplyr::filter(Trimestre == 3)  
dadosPNADc2023_3SR <- srvyr::as_survey(dadosPNADc2023_3SR)
```
...
```{r}
dadosPNADc2023_4SR <- dadosPNADC_2023 %>% 
  dplyr::filter(Trimestre == 4)  
dadosPNADc2023_4SR <- srvyr::as_survey(dadosPNADc2023_4SR)
```
