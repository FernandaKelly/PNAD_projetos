...
```{r}
dadosPNADc_2023_1 <- PNADcIBGE::get_pnadc(year = 2023,
                                         quarter = 1,
                                         vars = c("UF", "V4039C", "VD4002", "V4013"),
                                         design = TRUE)

dadosPNADc_2023_2 <- PNADcIBGE::get_pnadc(year = 2023,
                                         quarter = 2,
                                         vars = c("UF", "V4039C", "VD4002", "V4013"),
                                         design = TRUE)

dadosPNADc_2023_3 <- PNADcIBGE::get_pnadc(year = 2023,
                                         quarter = 3,
                                         vars = c("UF", "V4039C", "VD4002", "V4013"),
                                         design = TRUE)

dadosPNADc_2023_4 <- PNADcIBGE::get_pnadc(year = 2023,
                                         quarter = 4,
                                         vars = c("UF", "V4039C", "VD4002", "V4013"),
                                         design = TRUE)
```
...
```{r}
dadosPNADc_2023_1 <- dadosPNADc_2023_1$variables %>% 
