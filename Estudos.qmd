...
- Trimestre
- UF
- horas efetivamente trabalhadas no trabalho principal (V4039C)
- pessoas ocupadas (VD4002, filtrar apenas 1 - ocupado)
- lista CNAE 5 digitos (V4013)
...
```{r}
dadosPNADc_20231 <- PNADcIBGE::get_pnadc(year = 2023,
                                         quarter = 1)
