...
dadosRS_ACUMULADA_RS <- table_PS_MM_2 %>% 
  dplyr::arrange(atividade) %>% 
  dplyr::group_by(atividade) %>%
  dplyr::mutate(
    taxa_ACUMULADA_N = 100 * (indicadorVA_N_MM4 - lag(indicadorVA_N_MM4,4)) / lag(indicadorVA_N_MM4,4),
    taxa_ACUMULADA_qtd_HHabituais = 100 * (indicadorVA_qtd_HHabituais_MM4 - lag(indicadorVA_qtd_HHabituais_MM4,4)) / lag(indicadorVA_qtd_HHabituais_MM4,4),
    taxa_ACUMULADA_qtd_HEfetivas = 100 * (indicadorVA_qtd_HEfetivas_MM4 - lag(indicadorVA_qtd_HEfetivas_MM4,4)) / lag(indicadorVA_qtd_HEfetivas_MM4,4),
  ) %>%
  ungroup()
