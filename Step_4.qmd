...
#Cor ou raça
dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V2010) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))

#Situação do domicílio
dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V1022) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))

dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V1022, V2007) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))

#Condição no domicílio
dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V2005) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))
...
dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V2005, V2007) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))

dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V2005, V2007, V2010) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))


#Número de pessoas no domicílio
dadosPNADc2025_DM_srv %>% 
  dplyr::group_by(V2005, V1022,V2001) %>% 
  dplyr::summarise(freq = srvyr::survey_total(vartype = c("se", "ci", "var", "cv")))
