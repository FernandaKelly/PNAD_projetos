...
table_1R_2012 <- dadosPNADc1VISITA_2012 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
...
table_1R_2013 <- dadosPNADc1VISITA_2013 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2014 <- dadosPNADc1VISITA_2014 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2015 <- dadosPNADc1VISITA_2015 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2016 <- dadosPNADc1VISITA_2016 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2017 <- dadosPNADc1VISITA_2017 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2018 <- dadosPNADc1VISITA_2018 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2019 <- dadosPNADc1VISITA_2019 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2020 <- dadosPNADc5VISITA_2020 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2021 <- dadosPNADc5VISITA_2021 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043,  Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2022 <- dadosPNADc5VISITA_2022 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2023 <- dadosPNADc1VISITA_2023 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R_2024 <- dadosPNADc1VISITA_2024 %>%  
  dplyr::mutate(Qtd_renda = base::sum(VD4017, V405112, V405122, na.rm = TRUE)) %>% 
  dplyr::group_by(V4013, V4012, V4043, Ano) %>% 
  dplyr::summarise(freq = srvyr::survey_total(),
                   Qtd_renda = srvyr::survey_total(Qtd_renda,
...
table_1R <- table_1R_2012 %>% 
  dplyr::bind_rows(table_1R_2013,
                   table_1R_2014,
                   table_1R_2015,
                   table_1R_2016,
                   table_1R_2017,
...
writexl::write_xlsx(table_1R, 
           paste0("C:/Users/fernanda-romeiro/OneDrive - Governo do Estado do Rio Grande do Sul/Projetos/PNAD/PNAD_projetos/Dados/table_PSR_12_24_1.xlsx"))
