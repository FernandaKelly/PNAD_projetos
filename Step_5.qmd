...
<!-- ```{r} -->
<!-- dadosPNADc2023_BR <- dadosPNADc2023_BR %>%  -->
...
<!-- dadosPNADc2023_BRP  <- PNADcIBGE::pnadc_design(dadosPNADc2023_BR) -->
<!-- dadosPNADc2023_BR_PSV <- srvyr::as_survey(dadosPNADc2023_BRP) -->

<!-- table_P <- dadosPNADc2023_BR_PSV %>%  -->
<!--   dplyr::mutate(VD4002 = base::as.numeric(VD4002)) %>%  -->
<!--   dplyr::group_by(V4013) %>%  -->
<!--   dplyr::summarise(N_P = srvyr::survey_total(VD4002 == 1, -->
...
<!-- # ```{r} -->
<!-- #  -->
<!-- # dadosPNADc2023_BRS  <- PNADcIBGE::pnadc_design(dadosPNADc2023_BR) -->
<!-- # dadosPNADc2023_BR_PSV <- srvyr::as_survey(dadosPNADc2023_BRS) -->
<!-- #  -->
<!-- # table_S <- dadosPNADc2023_BR_PSV %>%                                            -->
<!-- #   dplyr::mutate(VD4002 = base::as.numeric(VD4002)) %>%                                               -->
<!-- #   dplyr::group_by(V4044) %>%  -->
<!-- #   dplyr::summarise(N_S = srvyr::survey_total(VD4002 == 1, -->
<!-- #                                              vartype = c("se", "ci", "var", "cv"), -->
<!-- #                                              na.rm = TRUE)) -->
<!-- #  -->
<!-- # ``` -->
